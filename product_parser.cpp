...
Product *ProductParser::parse(string category, istream &is, bool &error,
                              string &errorMsg, int &lineno) {
...
void ProductParser::parseCommonProduct(std::istream &is, bool &error,
                                       string &errorMsg, int &lineno)
...
Product *ProductBookParser::makeProduct() {
  ...
  Book *bookObject = new Book(prodName_, author_, isbn_, price_, qty_);
  return bookObject;
}
...
Product *ProductClothingParser::makeProduct() {
  ...
  Clothing *clothingObject =
      new Clothing(prodName_, size_, brand_, price_, qty_);
...
Product *ProductMovieParser::makeProduct() {
  ...
  Movie *movieObject = new Movie(prodName_, genre_, rating_, price_, qty_);
  return movieObject;
}

...
public:
   ...
   */
  Product *parse(std::string category, std::istream &is, bool &error,
                 std::string &errorMsg, int &lineno);
...
protected:
   ...
   */
  void parseCommonProduct(std::istream &is, bool &error, std::string &errorMsg,
                          int &lineno);
   ...
   */
  virtual Product *parseSpecificProduct(std::string category, std::istream &is,
...
public:
  ProductBookParser();
  Product *parseSpecificProduct(std::string category, std::istream &is,
                                bool &error, std::string &errorMsg,
                                int &lineno);
